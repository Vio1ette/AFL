...
static void add_to_queue(u8* fname, u32 len, u8 passed_det) {
  ...
  q->len          = len;
  q->depth        = cur_depth + 1;
  q->passed_det   = passed_det; //�Ƿ��Ѿ���� deterministic ����׶���

  if (q->depth > max_depth) max_depth = q->depth;

  if (queue_top) {

    queue_top->next = q; //queue_top ָ��ձ��ӽ�ȥ��Ԫ�ذ����Ǻ���İ������pop()���������Ļ������Ǳ���˺���ȳ���
    queue_top = q;
    ...
    if (unlikely(*current) && unlikely(*current & *virgin)) {
      if (likely(ret < 2)) {
        ...
        if ((cur[0] && vir[0] == 0xff) || (cur[1] && vir[1] == 0xff) ||
            ...
            (cur[6] && vir[6] == 0xff) || (cur[7] && vir[7] == 0xff)) ret = 2; //һ���ж�8����֧
        else ret = 1;
  ...
  for (i = 0; i < MAP_SIZE; i++)
    ...
    if (trace_bits[i]) {
       ...
       if (!q->trace_mini) {
         ...
         // ����һ������ΪʲôҪ�� MAP_SIZE >> 3���Ҿ���ԭ�����ԭ��һ���ߵ�ִ�д�����Ҫ��һ���ֽ�����
         // �� trace_mini ���������ֻ�渲��û�У�ֻ��Ҫһ��λ�Ϳ��Ա�ʾһ���ߵĸ������
...
EXP_ST void setup_shm(void) {
  ...
  //�����ǰѹ����ڴ��е���������һ���Ӷ����˳�����
  trace_bits = shmat(shm_id, NULL, 0); //shmat���ص���һ�� void* ���͵�ָ��
...
static void read_testcases(void) {
  ...
  for (i = 0; i < nl_cnt; i++) { // n1_cnt�����ļ�����input�ĸ���
    ...
    if (lstat(fn, &st) || access(fn, R_OK)) //lstat��ȡ�ļ���Ϣ
...
EXP_ST void init_forkserver(char** argv) {
  ...
  int st_pipe[2], ctl_pipe[2]; //fuzzer �� fork server ͨ��
  int status;
  s32 rlen;
...
// ������fuzzer ��ȡ״̬������õ����ֽڵġ�hello����Ϣ��˵��fork server�Ѿ�׼������
...
static u8 run_target(char** argv, u32 timeout) {
  ...
  if (dumb_mode == 1 || no_forkserver) {
    ...
    /* In non-dumb mode, we have the fork server up and running, so simply
       ...
       //�� fork server�������֮��һ����Ҫִ��ĳ��������������fuzzer�����run_target()����
       //�ڴ˷����� ������ͨ������ܵ�������fork server׼��fork����ͨ��״̬�ܵ�����ȡ�ӽ���pid
...
havoc_stage:
  ...
  for (stage_cur = 0; stage_cur < stage_max; stage_cur++) { // stage_max ������й�
    ...
    for (i = 0; i < use_stacking; i++) {
      ...
      switch (UR(15 + ((extras_cnt + a_extras_cnt) ? 2 : 0))) {
        ...
        case 0:
          ...
          FLIP_BIT(out_buf, UR(temp_len << 3)); //�����תĳһλ
          break;
...
// ��Ҫͨ�� getopt ��ȡ���ֻ������á�ѡ�������..
  ...
  while (1) {
    ...
    if (!queue_cur) {
      ...
      if (queued_paths == prev_queued) { //���queue����������֮ǰ��һ����˵��û�з����µ����������������������
    ...
    skipped_fuzz = fuzz_one(use_argv); // ����Ψһ����fuzz_one�ĵط�
